...
//			if ( $time_ago > 300 ) { //update every 5 minutes
			if ( $time_ago > s ) { //update every 5 minutes
...
//			if ( $time_ago > 43200 ) { //12 hour refreshing
			...
			if ( $time_ago > 1 ) { //12 hour refreshing
				$this->process();
			}
...
?>
      ...
      <p><small>* <?php _e('Latest plugins, themes and installed plugins and themes above only refer to those provided to', $this->network) ?> <a href="http://mydomain.com/join/"><?php _e('WPMU DEV members'); ?></a> <?php _e('by Incsub - other plugins and themes are not included here.', $this->network); ?></small></p>
